import { 
    IsDateString, IsBoolean, IsEmail, IsEnum, IsNotEmpty, 
    IsOptional, IsString, MaxLength, MinLength, Matches 
  ...
  export class CreateEtudiantDto {
    ...
    @MaxLength(50, { message: 'La nationalité ne peut pas dépasser 50 caractères' })
    nationalite: string;
