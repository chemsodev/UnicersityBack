...
export class DepartmentController {
    ...
    async addSection(
        ...
        return this.departmentService.addSectionToDepartment(departmentId, sectionId);
    }
    ...
    async removeSection(
        ...
        return this.departmentService.removeSectionFromDepartment(departmentId, sectionId);
    }
}